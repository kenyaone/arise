        ...
        if ($lesson && ($lesson['lesson_type'] ?? '') === 'interactive' && !empty($lesson['file_path'])) {
            ...
            if (file_exists($htmlFile)) {
                ...
                if ($_nm) {
                    ...
                    $nextFloatBtn = '<a id="arise-next-module-btn" href="/arise/?p=module&slug=' . $nmSlugE . '" title="Proceed to: ' . $nmTitleE . '" style="position:fixed;bottom:74px;right:14px;z-index:99998;display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,#0a5e2a,#1a8a40);color:#fff;border-radius:999px;padding:10px 18px;font-size:.85rem;font-weight:800;text-decoration:none;box-shadow:0 6px 20px rgba(10,94,42,.45);"><span>Next Module</span><span style="font-size:1.05rem;">&rarr;</span></a>';
                } else {
                    ...
                    $nextFloatBtn = '<a id="arise-next-module-btn" href="/arise/?p=modules" style="position:fixed;bottom:74px;right:14px;z-index:99998;display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,#f5a623,#e8891a);color:#fff;border-radius:999px;padding:10px 18px;font-size:.85rem;font-weight:800;text-decoration:none;box-shadow:0 6px 20px rgba(245,166,35,.45);">🎉 All Modules</a>';
                }
