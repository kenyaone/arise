...
<title>ARISE Platform — Features & Benefits</title>
<style>
...
<div class="section">
  <div class="cta">
    ...
    <p>ARISE is designed for schools that want to teach adolescent health effectively—offline, safely, and with measurable results.</p>
...
<div class="section">
  <div class="footer">
    ...
    <p style="font-size:.85rem;margin-top:20px">© <?= date('Y') ?> ARISE • Open-source platform for health education</p>
  </div>
</div>
